...
### Day 2: 系统监控与状态机逻辑 (ETA: 1天) [计划中]

- **任务 2.1 (TDD)**: 系统监控数据获取 (CPU) [计划中]
  - 实现：引入 psutil 库，实现获取CPU平均使用率的功能
  - 测试：验证CPU使用率获取的准确性及异常处理

- **任务 2.2 (TDD)**: 简化桌宠状态机 [计划中]
