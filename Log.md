...
- [2025-05-15] [测试] 为核心占位符动画 (idle, busy, clicked, morning, night) 编写单元测试 - 详见 [Logs/tests/2025-05-15_placeholder_animation_tests.md]
  - 为五个核心状态的 `create_animation()` 函数创建了单元测试。
  - 测试覆盖了动画对象的返回类型、基本属性（名称、FPS、循环性）、元数据以及帧的有效性和尺寸。
  - 所有测试均已通过。
